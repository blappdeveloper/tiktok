...
import com.leeladher.shortvideo.models.commentmodel;
...
public class commentpanel extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        commentref=FirebaseDatabase.getInstance().getReference().child("video").child(postkey).child("comments");
        ...
        recview.setLayoutManager(new LinearLayoutManager(this));
                ...
                commentsubmit.setOnClickListener(new View.OnClickListener() {
                            ...
                            userref.child(userId).addValueEventListener(new ValueEventListener() {
                                ...
                                public void onDataChange(@NonNull DataSnapshot snapshot) {
                                   if(snapshot.exists())
                                   {
                                       ...
                                       String uimage=snapshot.child("pimage").getValue().toString();
                    ...
                    private void processcomment(String username, String pimage)
                    {
